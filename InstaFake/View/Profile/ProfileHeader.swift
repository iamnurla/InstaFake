...
class ProfileHeader: UICollectionReusableView {
    ...
    private lazy var postLabel: UILabel = {
        ...
        label.attributedText = attributedStatText(value: 12, label: "posts")
        return label
    }()
    ...
    override init(frame: CGRect) {
        ...
        fullNameLabel.anchor(top: profileImageView.bottomAnchor, left: leftAnchor,
                             paddingTop: 12, paddingLeft: 12)
        
        addSubview(editProfileButton)
        editProfileButton.anchor(top: fullNameLabel.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 16, paddingLeft: 24, paddingRight: 24)
